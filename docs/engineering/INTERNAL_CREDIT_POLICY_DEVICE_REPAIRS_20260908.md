...
Focused corrected Flutter tests: 43 pass. Edge Function gate: 131 pass, zero failures/errors/skips. New contracts cover enabled internal allowance disclosure, separate purchased balances, credit outcomes, and concurrent consumption readback including rejected voided/mismatched proofs.
