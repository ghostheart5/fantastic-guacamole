...
enum AppDiagnosticCode {
  ...
  startupBootstrapTimedOut('startup.bootstrap_timed_out'),
  startupBootstrapFailed('startup.bootstrap_failed'),
  startupQuiescenceTimedOut('startup.quiescence_timed_out'),
  startupReadinessBlocked('startup.readiness_blocked'),
  startupStorageFailed('startup.storage_failed'),
  startupFirebaseFailed('startup.firebase_failed'),
  startupSupabaseFailed('startup.supabase_failed'),
  startupIdentityTimedOut('startup.identity_timed_out'),
  startupIdentityFailed('startup.identity_failed'),
  startupPreferencesTimedOut('startup.preferences_timed_out'),
  startupPreferencesFailed('startup.preferences_failed'),
  startupAccountBoundaryTimedOut('startup.account_boundary_timed_out'),
  startupAccountBoundaryFailed('startup.account_boundary_failed'),
  startupStateTimedOut('startup.state_timed_out'),
  startupStateFailed('startup.state_failed'),
