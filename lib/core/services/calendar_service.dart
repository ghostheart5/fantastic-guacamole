import 'package:fantastic_guacamole/data/models/calendar_entry.dart';
...
class CalendarService {
  ...
  List<TimeBlock> generateAdaptivePlan({
    ...
    for (final Task task in ranked) {
      ...
      cursor = end.add(_adaptiveBreak(normalizedEnergy));
    }
  ...
  double _adaptiveTaskScore(Task task, double energy) {
    ...
    final double effortFit = (1 - (task.energyRequired - energy).abs()) * 30;
