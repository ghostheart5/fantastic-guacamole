...
/// The durable outcome authority for one actionable task occurrence.
///
/// A task definition can recur.  Its terminal outcome and any rescheduling
/// history belong here so a retry, restart, or account handoff cannot turn one
/// logical occurrence into two outcomes.
...
class TaskOccurrence {
  ...
  /// A stable key for the task's current actionable slot.
  ///
  /// The compatibility fallback intentionally ignores `scheduledFor`: that
  /// mutable value cannot prove the original occurrence after a legacy delay.
