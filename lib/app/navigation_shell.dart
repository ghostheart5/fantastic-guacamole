        ...
        return SafeArea(
          child: ListView(
            ...
            children: [
              ...
              navItem('Trajectory', 'Future scenarios and execution', AppView.tasks),
              navItem('Timeline', 'Decision memory and context history', AppView.logs),
              navItem('Profile', 'Identity and progression', AppView.profile),
              const Divider(),
              navItem('Plan', 'Adaptive schedule', AppView.plan),
              navItem('Creator', 'Turn intention into connected action', AppView.creator),
              navItem(
                'Milestones',
              ...
              navItem('SI Console', 'Turn context into a decision brief', AppView.console),
              navItem('Progression', 'See capabilities built through action', AppView.progression),
