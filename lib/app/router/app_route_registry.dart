...
abstract final class AppRouteRegistry {
  static const List<AppRouteDefinition> canonical = <AppRouteDefinition>[
    ...
    AppRouteDefinition(
      ...
      navigationOrder: 0,
      navigationSubtitle: 'Live decisions, signals and user control',
      allowSavedTabRestore: true,
    ),
    AppRouteDefinition(
      path: RoutePaths.creator,
      label: 'Reality Builder',
      ...
      navigationOrder: 0,
      navigationSubtitle: 'Turn intent into linked goals, tasks and context',
    ),
    AppRouteDefinition(
    ...
    AppRouteDefinition(
      ...
      navigationGroup: AppNavigationGroup.secondary,
      navigationOrder: 4,
      navigationSubtitle: 'Privacy, memory, intelligence and account controls',
    ),
    AppRouteDefinition(
    ...
    AppRouteDefinition(
      ...
      navigationGroup: AppNavigationGroup.primary,
      navigationOrder: 3,
      navigationSubtitle: 'Identity, continuity and capability',
    ),
    AppRouteDefinition(
      ...
      navigationGroup: AppNavigationGroup.secondary,
      navigationOrder: 3,
      navigationSubtitle: 'See capabilities proven through action',
    ),
    AppRouteDefinition(
      path: RoutePaths.si,
      ...
      navigationGroup: AppNavigationGroup.secondary,
      navigationOrder: 2,
      navigationSubtitle: 'Interrogate context, evidence and possible outcomes',
    ),
    AppRouteDefinition(
    ...
    AppRouteDefinition(
      ...
      navigationGroup: AppNavigationGroup.primary,
      navigationOrder: 2,
      navigationSubtitle: 'Decision receipts, outcomes and correctable history',
    ),
    AppRouteDefinition(
      ...
      navigationGroup: AppNavigationGroup.secondary,
      navigationOrder: 1,
      navigationSubtitle: 'Resolve real constraints into one executable move',
    ),
    AppRouteDefinition(
      ...
      navigationGroup: AppNavigationGroup.primary,
      navigationOrder: 1,
      navigationSubtitle: 'Compare possible paths without pretending certainty',
    ),
    AppRouteDefinition(
