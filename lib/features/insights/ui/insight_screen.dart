...
/// CHRONOSPARK-CLASS: LEGACY | Output surface, not a product feature.
///
/// Insight is an output generated by Smart Planner and the SI systems, not a
/// standalone ChronoSpark feature. This screen is retained as a detail view of
/// that output and stays reachable via `AppView.insight` and `RoutePaths.insights`
/// so existing navigation and deep links keep working. Do not treat it as a
