...
class PersonalAlignmentScreen extends ConsumerWidget {
  const PersonalAlignmentScreen({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final PersonalAlignmentSummary summary = ref.watch(
      personalAlignmentSummaryProvider,
    );
    final PersonalAlignmentProfile profile = ref.watch(
      personalAlignmentProfileProvider,
    );
    final PersonalAlignmentFutureSelfComparison comparison = ref.watch(
            ...
            child: Column(
              ...
              children: [
                ...
                _Panel(
                  ...
                  title: 'AUTHORED PERSONAL ALIGNMENT',
                  titleColor: AppColors.neonCyan,
                  trailing: TextButton(
                    onPressed: () =>
                        _openPersonalAlignmentEditor(context, ref, profile),
                ...
                _Panel(
                  borderColor: AppColors.neonViolet.withValues(alpha: 0.25),
                  title: 'PERSONAL ALIGNMENT ANALYSIS',
                  titleColor: AppColors.neonViolet,
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      Text(
                        'Strongest Area: ${personalAlignmentDimensionTitle(alignment.strongest)}',
                        style: const TextStyle(
                          color: Colors.white,
                          fontSize: 13,
                      ...
                      Text(
                        'Weakest Area: ${personalAlignmentDimensionTitle(alignment.weakest)}',
                        style: const TextStyle(
                          color: Colors.white,
                          fontSize: 13,
                          fontWeight: FontWeight.w600,
                ...
                _Panel(
                  borderColor: AppColors.neonCyan.withValues(alpha: 0.25),
                  title: 'PERSONAL ALIGNMENT SECTIONS',
                  titleColor: AppColors.neonCyan,
                  child: Column(
                    children: PersonalAlignmentDimension.values
                        .map(
                          (PersonalAlignmentDimension dimension) => Padding(
...
class _DimensionCard extends StatelessWidget {
  ...
  final PersonalAlignmentDimensionScore score;

  @override
  Widget build(BuildContext context) {
    final PersonalAlignmentDimensionDefinition definition = score.definition;
...
Future<void> _openPersonalAlignmentEditor(
  BuildContext context,
  WidgetRef ref,
  PersonalAlignmentProfile current,
) async {
      ...
      return Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              const Text(
                'Edit PersonalAlignment Profile',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 16,
                  fontWeight: FontWeight.w700,
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    final PersonalAlignmentProfile next = current.copyWith(
                    ...
                    await ref
                        .read(personalAlignmentProfileProvider.notifier)
                        .setProfile(next);
                    if (ctx.mounted) {
                      Navigator.of(ctx).pop();
                    }
                  },
                  child: const Text('Save PersonalAlignment Profile'),
                ),
              ),
            ],
          ),
