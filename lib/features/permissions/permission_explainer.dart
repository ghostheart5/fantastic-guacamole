...
class PermissionExplainers {
  ...
  static const PermissionExplainer notificationSpanish = PermissionExplainer(
    ...
    whenUsed:
        'Solo se usan para recordatorios que programes o actives. Axiomara sigue funcionando si no das permiso.',
