...
class CreateFinancialGoalUsecase {
  const CreateFinancialGoalUsecase(this._repository);
  ...
  Future<GoalEntity> call({
    ...
    final GoalEntity goal = GoalEntity(
      id: 'financial_goal_${now.microsecondsSinceEpoch}',
      title: title.trim().isEmpty ? 'Financial goal' : title.trim(),
      createdAt: now,
      description: description?.trim().isEmpty ?? true
          ? 'Financial goal created in ChronoSpark.'
          : description?.trim(),
