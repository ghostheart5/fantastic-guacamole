...
class HabitsRemoteGateway {
  const HabitsRemoteGateway(this._client);
  ...
  Map<String, dynamic> _ownedRow(
    ...
    if (userId == null || userId.isEmpty) {
      throw StateError('An authenticated user is required for habit sync.');
    }
    ...
    if (claimedUserId != null &&
      ...
      throw StateError(
        'Habit sync payload user does not match the active user.',
      );
    }
