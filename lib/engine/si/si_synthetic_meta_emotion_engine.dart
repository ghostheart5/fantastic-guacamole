...
class SISyntheticMetaEmotionEngine {
  ...
  String _secondary(SIContext context, AttentionProfile? attention) {
    if (attention != null && attention.primaryTarget.startsWith('instinct:')) {
  ...
  double _stability(
    ...
    final double attentionBoost = (attention?.attentionScore ?? 0.5) * 0.15;
    return siClamp01(
  ...
  String _guidance({
    ...
    if (primary == 'excited' && stability >= 0.55) return 'engaged_momentum';
