...
/// Serializes a task's durable state with its occurrence outcome journal.
///
/// The coordinator is bound to the scope which constructed it. Once lifecycle
/// teardown begins it rejects new commands and drains any in-flight command
/// before identity handoff can occur.
