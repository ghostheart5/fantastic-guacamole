...
class OperatingBriefingCard extends StatelessWidget {
  const OperatingBriefingCard({
  ...
  Widget build(BuildContext context) {
    ...
    final List<OperatingChange> changes = briefing.delta.materialChanges;
    return Semantics(
      container: true,
      liveRegion: briefing.hasUnacknowledgedChange,
      label: '$title. ${briefing.delta.summary}',
      child: Container(
          ...
          children: <Widget>[
            ...
            Wrap(
              ...
              children: <Widget>[
                ...
                if (briefing.hasUnacknowledgedChange && onAcknowledge != null)
                  TextButton(
                    onPressed: onAcknowledge,
                    child: const Text('Mark briefing reviewed'),
                  ),
              ],
            ),
          ],
