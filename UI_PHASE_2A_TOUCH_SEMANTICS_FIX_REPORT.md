...
| `lib/features/home/ui/smart_planner_screen.dart` | Back button, SPEAK pill, SUMMARY pill, ACCESS pill, mic toggle, and quick-navigation controls | Combined | Padding/size/`Semantics` only; all `onTap` callbacks and provider calls unchanged |
...
- **Naming cleanup:** no "SMART PLANNER"/"Session"/standalone "Signal" copy was encountered inside any control touched in this pass; no naming changes were made or needed.
