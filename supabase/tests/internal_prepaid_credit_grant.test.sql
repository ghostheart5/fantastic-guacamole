...
select public.bind_verified_purchase_token(repeat('9',64),
 '89898989-8989-4989-8989-898989898989','chronospark_premium_monthly',now()+interval '1 second',null);
...
select public.bind_verified_purchase_token(repeat('a',64),'89898989-8989-4989-8989-898989898989','chronospark_premium_monthly',now()+interval '5 seconds',null);
...
select is((select purchase_token_hash from public.monetization_subscription_statuses where user_id='89898989-8989-4989-8989-898989898989'),repeat('a',64),'negative a reaches reconciliation rather than stale-token rejection');
...
select public.bind_verified_purchase_token(repeat('b',64),'89898989-8989-4989-8989-898989898989','chronospark_premium_monthly',now()+interval '6 seconds',null);
...
select is((select purchase_token_hash from public.monetization_subscription_statuses where user_id='89898989-8989-4989-8989-898989898989'),repeat('b',64),'negative b reaches reconciliation rather than stale-token rejection');
...
select public.bind_verified_purchase_token(repeat('c',64),'89898989-8989-4989-8989-898989898989','chronospark_premium_monthly',now()+interval '7 seconds',null);
...
select is((select purchase_token_hash from public.monetization_subscription_statuses where user_id='89898989-8989-4989-8989-898989898989'),repeat('c',64),'negative c reaches reconciliation rather than stale-token rejection');
...
select public.bind_verified_purchase_token(repeat('d',64),'89898989-8989-4989-8989-898989898989','chronospark_premium_monthly',now()+interval '8 seconds',null);
