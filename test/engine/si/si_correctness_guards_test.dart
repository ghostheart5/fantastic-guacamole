...
void main() {
  group('SI correctness guards', () {
    test('intent classification maps common request types', () {
      expect(classifySIIntent('what task should I do next?').label, 'task_recommendation');
    ...
    test('grounding validation strips unknown task references and marks ungrounded', () {
    ...
    test('confidence calibration stays bounded and penalizes fallback paths', () {
