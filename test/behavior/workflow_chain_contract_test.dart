...
void main() {
  group('Workflow chain contract', () {
    test('creator to timeline to completion to progression chain stays wired', () {
      final File taskProvider = File('lib/state/providers/task_provider.dart');
      final File timelineProvider = File('lib/state/providers/timeline_provider.dart');
      final File progressionProvider = File('lib/state/providers/progression_provider.dart');
      final File appRouter = File('lib/app/router/app_router.dart');
      final File completionUsecaseTest = File('test/unit/complete_task_usecase_test.dart');
      ...
      final String progressionText = SourceTestUtils.readText(progressionProvider);
      ...
      expect(timelineText.contains('timelineCompletedEventsProvider'), isTrue);
      ...
      expect(progressionText.contains('service.fromProfile(profile)'), isTrue);
