  ...
  group('Controller source behavior', () {
    test('controllers expose action methods and are not empty shells', () {
      ...
      expect(
        offenders,
        isEmpty,
        reason: 'Controllers missing real behavior: $offenders',
      );
    });
    ...
    test('controllers avoid importing UI screens/widgets directly', () {
      ...
      expect(
        offenders,
        isEmpty,
        reason: 'Controllers should not couple to UI layer: $offenders',
      );
    });

    test(
      'controller filenames align with declared class/controller identifiers',
      () {
        final List<String> offenders = <String>[];
        ...
        expect(
          offenders,
          isEmpty,
          reason: 'Controller naming drift detected: $offenders',
        );
      },
    );
  });
