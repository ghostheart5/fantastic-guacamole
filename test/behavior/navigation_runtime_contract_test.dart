...
void main() {
  group('Navigation runtime contract', () {
    test('lib does not use BottomNavigationBar, NavigationBar, or NavigationDestination', () {
      ...
      expect(
        offenders,
        isEmpty,
        reason: 'Bottom navigation widgets are not allowed by architecture: $offenders',
      );
    });
    ...
    test('creator and timeline route semantics are preserved', () {
      ...
      expect(routes.contains("static const timeline = '/settings/advanced/logs';"), isTrue);
    });
