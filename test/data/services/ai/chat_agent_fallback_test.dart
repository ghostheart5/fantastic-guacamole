...
void main() {
  ...
  test('execute returns structured local response when proxy is not configured', () async {
    final Map<String, dynamic> result = await agent.execute(<String, dynamic>{
      ...
      'history': const <Map<String, String>>[
        <String, String>{'role': 'user', 'content': 'I am deciding next action.'},
      ],
    });
  ...
  test('execute handles blank prompt without throwing and returns safe payload', () async {
    final Map<String, dynamic> result = await agent.execute(const <String, dynamic>{
      'prompt': '   ',
      'tasks': <Task>[],
    });
