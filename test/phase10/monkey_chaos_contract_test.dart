...
void main() {
  test(
    ...
    () {
      ...
      final Map<String, dynamic> prSmoke =
          levels['pr-smoke'] as Map<String, dynamic>;
      final Map<String, dynamic> nightly =
          levels['nightly'] as Map<String, dynamic>;
      final Map<String, dynamic> preRelease =
          levels['pre-release'] as Map<String, dynamic>;
      expect(prSmoke['eventCount'], 1000);
      expect(nightly['eventCount'], 10000);
      expect(preRelease['eventCount'] as int, inInclusiveRange(50000, 100000));
