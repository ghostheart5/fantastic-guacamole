...
void main() {
  group('autonomousDailyPlannerProvider', () {
    test(
      'focus and directive priorities are derived from action and weekly plan',
      () {
        ...
        final AutonomousDailyPlan plan = container.read(
          autonomousDailyPlannerProvider,
        );
    ...
    test(
      'secondary directive priority scales down when action priority is below 90',
      () {
        final ProviderContainer container = ProviderContainer(
          overrides: [
            autonomousActionProvider.overrideWithValue(
