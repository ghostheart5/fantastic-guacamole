...
void main() {
  test(
    'SI Console preserves task, habit, goal, and timeline context for a focus query',
    () {
      ...
      final List<MemoryEntity> memories = <MemoryEntity>[
        MemoryEntity(
          id: 'memory-1',
          text:
              'Launch prep works best when the daily review ritual happens first.',
          date: fixedNow,
      ...
      final Map<String, dynamic> assistantContext = contextBuilder
          .buildSIConsoleContext(
            input: userInput,
      ...
      final Map<String, dynamic> chronosparkModel = contextBuilder
      ...
      final List<String> assistantTimelineSummaries =
          (assistantContext['timelineSummaries'] as List<dynamic>)
              .cast<String>();
      ...
      expect(
        output,
        isNot(contains('I do not have a materially new grounded answer yet')),
      );
