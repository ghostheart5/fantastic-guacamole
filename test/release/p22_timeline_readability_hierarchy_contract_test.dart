...
void main() {
  group('P2-2 timeline readability hierarchy contract', () {
    test(
      'timeline day grouping uses normalized dates and sorted day buckets',
      () {
        final File timelineScreenFile = File(
    ...
    test(
      'timeline day headers include relative labels and per-day item counts',
      () {
        final File timelineScreenFile = File(
          'lib/features/timeline/ui/timeline_screen.dart',
        );
