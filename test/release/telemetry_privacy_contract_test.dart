...
void main() {
  ...
  test(
    'telemetry source keeps personal content and account identifiers local',
    () {
      final String logger = readSource('lib/core/debug/logger.dart');
      final String diagnostics = readSource(
        'lib/core/debug/runtime_diagnostics.dart',
      );
      final String providers = readSource(
      ...
      expect(
        privacyPolicy,
        contains(
          'Firebase Analytics and Crashlytics collection are disabled in this release.',
        ),
      );
    },
  );
