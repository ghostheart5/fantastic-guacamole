...
void main() {
  group('P4-1 Wave 3 routine/note timeline projection semantics contract', () {
    test('task-to-timeline projection derives semantic kind and title prefixes', () {
    ...
    test('task-to-timeline projection provides semantic default details for routine and note', () {
      final File connectUsecaseFile = File(
        'lib/features/auth/domain/usecases/misc/connect_timeline_to_tasks_usecase.dart',
      );
      expect(connectUsecaseFile.existsSync(), isTrue);
    ...
    test('creator routine persistence path now keeps routine kind for projection continuity', () {
