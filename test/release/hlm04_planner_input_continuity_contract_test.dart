...
void main() {
  test('Creator persistence feeds shared PlannerInput consumers without planner-owned persistence', () {
    ...
    final String smartPlanner = File('lib/state/controllers/smart_planner_query_controller.dart').readAsStringSync();
    ...
    expect(smartPlanner, contains('PlannerInputAdapter.fromLegacyTasks'));
