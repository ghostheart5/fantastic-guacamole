...
void main() {
  group('P2-4 connector workflow contract', () {
    ...
    test(
      'timeline connector layer keeps usecase boundaries and event bus emission',
      () {
        ...
        expect(
          text.contains('connectTimelineToProjectsUsecaseProvider'),
          isTrue,
        );
    ...
    test('core workflow providers avoid direct network connector calls', () {
      ...
      for (final String path in providerPaths) {
        ...
        expect(
          text.contains('http.'),
          isFalse,
          reason: 'Direct HTTP usage found in $path',
        );
        expect(
          text.contains('Dio('),
          isFalse,
          reason: 'Direct Dio usage found in $path',
        );
        expect(
