...
void main() {
  group('Deep link release contract', () {
    test('router/deep link source exists when go_router or app_links dependencies are present', () {
      final String pubspec = SourceTestUtils.readText(File('pubspec.yaml')).toLowerCase();
      final bool hasDeepLinkDeps = pubspec.contains('go_router') || pubspec.contains('app_links');
