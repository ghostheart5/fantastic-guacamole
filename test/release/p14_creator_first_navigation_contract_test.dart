...
void main() {
  group('P1-4 creator-first navigation contract', () {
    test(
      'router initial location logic prioritizes creator when onboarding is incomplete or first item is missing',
      () {
    ...
    test(
      'navigation shell activation lock requires creator before first item is created',
      () {
