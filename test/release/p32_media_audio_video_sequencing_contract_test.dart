...
void main() {
  group('P3-2 media/audio/video sequencing contract', () {
    test(
      'app assets constants keep animation audio and background anchors',
      () {
    ...
    test(
      'audio service keeps cooldown and haptic-safe playback boundaries',
      () {
        ...
        expect(
          text.contains('static const Duration _kReminderCooldown'),
          isTrue,
        );
    ...
    test(
      'typing effect remains throttled and routed through audio service',
      () {
    ...
    test(
      'pubspec keeps declared media packages and core asset declarations',
      () {
