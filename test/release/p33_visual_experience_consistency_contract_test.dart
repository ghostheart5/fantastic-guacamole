...
void main() {
  group('P3-3 visual experience consistency contract', () {
    test(
      'app theme keeps dual-mode material3 and Inter typography anchors',
      () {
        ...
        expect(
          text.contains('final ThemeData appLightTheme = ThemeData('),
          isTrue,
        );
        expect(
    ...
    test('theme color system keeps neon signature tokens and gradients', () {
      ...
      expect(
        text.contains('const Color neonCyan = Color(0xFF00E5FF);'),
        isTrue,
      );
      expect(
        text.contains('const Color neonViolet = Color(0xFF9A4DFF);'),
        isTrue,
      );
      expect(
        text.contains('const Color neonMagenta = Color(0xFFFF2EC4);'),
        isTrue,
      );
      expect(
        text.contains('const LinearGradient cosmicGradient = LinearGradient('),
        isTrue,
      );
      expect(
        text.contains(
    ...
    test(
      'typography and ui color constants retain readability hierarchy aliases',
      () {
        ...
        expect(
          typographyText.contains('final TextTheme neonTextTheme ='),
          isTrue,
        );
        ...
        expect(
          uiColorsText.contains('static const textPrimary = Colors.white;'),
          isTrue,
        );
        expect(
          uiColorsText.contains('static const textSecondary = Colors.white70;'),
          isTrue,
        );
        expect(
          uiColorsText.contains('static const textMuted = Color(0xFFB6AEC4);'),
          isTrue,
        );
        expect(
          uiColorsText.contains('static const textDim = Color(0xFF8C839E);'),
          isTrue,
        );
        expect(
          uiColorsText.contains('static const bgPrimary = background;'),
          isTrue,
        );
        expect(
          uiColorsText.contains('static const neonCyan = Color(0xFF00E5FF);'),
          isTrue,
        );
        expect(
          uiColorsText.contains('static const neonViolet = Color(0xFF9B8AFB);'),
          isTrue,
        );
      },
    );
