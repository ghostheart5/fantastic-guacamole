...
void main() {
  group('Goal lifecycle provider contract', () {
    test(
      'goals provider keeps complete/archive/reopen on canonical transitions',
      () {
        ...
        expect(
          providerText.contains('Future<void> complete(String id) async'),
          isTrue,
        );
        expect(
        ...
        expect(
          providerText.contains('Future<void> archive(String id) async'),
          isTrue,
        );
        expect(
          providerText.contains(
        ...
        expect(
          providerText.contains('Future<void> reopen(String id) async'),
          isTrue,
        );
        expect(
          providerText.contains(
    ...
    test('goals provider keeps delete explicit and separate from complete', () {
      ...
      expect(
        providerText.contains('Future<void> remove(String id) async'),
        isTrue,
      );
      expect(
        providerText.contains(
